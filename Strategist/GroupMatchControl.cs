...
{
    public partial class GroupMatchControl : UserControl
    {
        public GroupMatchControl()
        {
            InitializeComponent();
        }

        public GroupMatchControl(ViewTournament viewTournament, int round, int numberMatch, Stage stage)
        {
            InitializeComponent();
        ...
        {
            set => Label_MatchPosition.Text = value;
        }
